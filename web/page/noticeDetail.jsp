...
<div class="content">
    <div class="wrp clearfix">
            ...
            <div class="newArticle">
                ...
                <div class="msgEditlabel clearfix">
                    <div class="halfPart"> <em class="frmLabel">发布时间</em>
                        <div class="frmInputBox frmInputBoxNoTextLimit">${data.notice_date}</div>
                        <!--<div class="pagesTips errorText" style="display:block;">一个字也没有，你还想保存？</div>-->
                    </div>
                </div>
                <div class="msgEditlabel clearfix">
        ...
        <div class="ctrlBar">
            ...
            <button class="ctrlBtn focusBtn" onClick="javascript:location.href='addNotice.html'">修改</button>
            <button class="ctrlBtn focusBtn" onClick="javascript:location.href='addNotice.html'">送审</button>
