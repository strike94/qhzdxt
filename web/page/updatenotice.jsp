...
<div class="content">
    ...
    <b class="ponitText">发布成功</b>
        ...
        <form action="<%=basePath %>back/notice/updatenotice" method="post" enctype="multipart/form-data">
            <div class="pulicBox">
                                ...
                                <div class="selectionGroup">
                                    <div class="dropDown"  style="width:120px;">
                                        <select data-placeholder="所在州" class="chosen-select-no-single" tabindex="9" name="local1" style="border: 0px;background: none">
                                            <option value="${data.notice_local1}">${data.notice_local1}</option>
                                ...
                                <div class="selectionGroup">
                                    <div class="dropDown"  style="width:120px;">
                                        <select data-placeholder="所在区县" class="chosen-select-no-single" tabindex="9" name="local2">
                                            <option value="${data.notice_local2}">${data.notice_local2}</option>
                                            <option value="全部">全部</option>
                                            <option value="已发布">已发布</option>
                                            <option value="未发布">未发布</option>
                                        </select>
                                ...
                                <div class="selectionGroup">
                                    <div class="dropDown"  style="width:120px;">
                                        <select data-placeholder="所在街道" class="chosen-select-no-single" tabindex="9" name="local3">
                                            <option value="${data.notice_local3}">${data.notice_local3}</option>
                                            <option value="全部">全部</option>
                                            <option value="已发布">已发布</option>
                                            <option value="未发布">未发布</option>
                                        </select>
