...
<div class="content">
    ...
    <b class="ponitText">发布成功</b>
        ...
        <form action="<%=basePath %>back/Plan/updatePlan" method="post" enctype="multipart/form-data">
        <div class="pulicBox">
        ...
        <div class="ctrlBar">
            ...
            <button class="ctrlBtn focusBtn" ype="submit" name="state" value="待提交">保存</button>
