...
<div class="content">
  ...
  <form action="<%=basePath %>back/Plan/Plandetail" method="post" enctype="multipart/form-data">
          ...
          <div class="msgEditlabel clearfix">
            <div class="halfPart"> <em class="frmLabel">公告名称</em>
              <div class="frmInputBox frmInputBoxNoTextLimit">
                <input type="text" class="textInput"  name="docnum"value="${data.Plan_name}" />
              </div>
      ...
      <div class="ctrlBar">
        ...
        <button class="ctrlBtn focusBtn" type="submit" name="state" value="">修改</button>
        <button class="ctrlBtn focusBtn" type="submit" name="state" value="">提交审核</button>
      </div>
  </form>
  </div>
</div>
