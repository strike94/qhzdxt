...
<div class="content">
  <div class="wrp clearfix">
    <div class="crumbs clearfix">
      <span class="backTo">
        <a href="javascript:history.go(-1)" class="backToIcon"></a>
        <a class="backLinks heightColor" href="javascript:history.go(-1)">拟征收土地补偿安置方案公告</a>
        <b class="partLine grayColor">/</b>
        <b>新增拟征收土地补偿安置方案公告</b>
      </span></div>
            ...
            <div class="frmInputBox frmInputBoxNoTextLimit">
              <div class="uploadBox">
                ...
                <div class="uploadFinish"><!--失败调用error--> 
                  <a href="javascript:;" class="loadName">${data.Plan_context}</a> </div>
              </div>
            </div>
            <!--<div class="pagesTips errorText" style="display:block;">一个字也没有，你还想保存？</div>--> 
          </div>
    ...
    <div class="ctrlBar">
      ...
      <button class="ctrlBtn focusBtn" onClick="javascript:location.href='addPlan.html'">修改</button>
      <button class="ctrlBtn focusBtn" onClick="">提交审核</button>
    </div>
  </div>
</div>
<script type="text/javascript">
